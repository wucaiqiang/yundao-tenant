...
public class BaseProductSupplierQuotationExample {
    ...
    public BaseProductSupplierQuotationExample() {
    ...
    public BaseProductSupplierQuotationExample setLimit(Limit limit) {
        this.limit=limit;
        return this;
    }
