...
public class CustomerOpenSeaPageReqDto extends AbstractBasePageDto {
    ...
    @ApiModelProperty(value = "生日，开始时间 PC端专用")
    private String birthdayBegin;

    @ApiModelProperty(value = "生日，结束时间 PC端专用")
    private String birthdayEnd;

    @ApiModelProperty(value = "标签，多个逗号分隔 PC端专用")
    private String tags;

    @ApiModelProperty(value = "投资偏好，多个逗号分隔 PC端专用")
    private String investTypes;

    @ApiModelProperty(value = "投资人类型，多个逗号分隔 PC端专用")
